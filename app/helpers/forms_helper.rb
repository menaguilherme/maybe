module FormsHelper
  ...
  private
    def radio_tab_contents(label:, icon:)
      tag.div(class: "flex px-4 py-1 rounded-lg items-center space-x-2 justify-center text-subdued group-has-checked:bg-surface group-has-checked:text-primary group-has-checked:shadow-sm") do
